...
export default function APISecurityTestingLanding() {
  ...
  const includedItems = [
    { text: 'Authentication & authorization testing' },
    { text: 'Rate limiting & throttling validation' },
    { text: 'JWT & token security analysis' },
    { text: 'Input validation & injection testing' },
    { text: 'API versioning security review' },
    { text: 'Schema validation & fuzzing' },
    { text: 'Authorization bypass attempts' },
    { text: 'Mass assignment vulnerability testing' }
  ];

  const scopeItems = [
    { icon: FileCode, title: 'REST APIs', desc: 'RESTful endpoint security' },
    { icon: Code, title: 'GraphQL', desc: 'Query security & depth limits' },
    { icon: Code, title: 'Microservices', desc: 'Service-to-service auth' },
    { icon: Lock, title: 'Authentication', desc: 'OAuth, JWT, API keys' },
    { icon: Zap, title: 'Rate Limiting', desc: 'Throttling mechanisms' },
    { icon: Shield, title: 'Authorization', desc: 'Access control testing' },
    { icon: FileText, title: 'Input Validation', desc: 'Data sanitization' },
    { icon: AlertCircle, title: 'Error Handling', desc: 'Information leakage' }
  ];
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="mb-6 md:mb-8">
            ...
            <p className="text-gray-400 text-base sm:text-lg md:text-xl max-w-full sm:max-w-2xl mb-6 sm:mb-8 leading-relaxed">
              Comprehensive security assessment of REST, GraphQL, and
              microservice APIs to identify authentication flaws, authorization
              bypass, and data exposure vulnerabilities.
            </p>
