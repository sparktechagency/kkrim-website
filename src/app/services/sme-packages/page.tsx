...
export default function SMESecurityPackagesLanding() {
  ...
  const includedItems = [
    { text: 'Bundled security assessment packages', featured: false },
    { text: 'Essential vulnerability coverage', featured: true },
    { text: 'Faster turnaround times (5-7 days)', featured: false },
    { text: 'SME-optimized pricing', featured: false },
    { text: 'Web app OR infrastructure testing', featured: false },
    { text: 'Executive-friendly reporting', featured: false },
    { text: 'Prioritized remediation guidance', featured: false },
    { text: 'Free retest included', featured: false }
  ];

  const scopeItems = [
    { icon: DollarSign, title: 'Cost-Effective', desc: 'Budget-friendly packages' },
    { icon: Zap, title: 'Fast Delivery', desc: '5-7 business days' },
    { icon: CheckCircle, title: 'Essential Coverage', desc: 'Critical vulnerabilities' },
    { icon: Shield, title: 'Compliance Ready', desc: 'Meet basic requirements' },
    { icon: Zap, title: 'Quick Start', desc: 'Minimal onboarding' },
    { icon: Target, title: 'Focused Scope', desc: 'High-impact areas' },
    { icon: Building2, title: 'SME Focused', desc: 'Built for small teams' },
    { icon: TrendingUp, title: 'Scalable', desc: 'Grow as you grow' }
  ];
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="mb-6 md:mb-8">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 leading-snug sm:leading-tight">
              SME / Small Business Security<br className="hidden sm:block" />Packages
            </h1>

            {/* Description */}
            <p className="text-gray-400 text-base sm:text-lg md:text-xl max-w-full sm:max-w-2xl mb-6 sm:mb-8 leading-relaxed">
              Enterprise-grade security testing tailored for small and medium
              businesses — essential coverage, faster timelines, and budget-
              friendly pricing.
            </p>
