...
export default function MobileAppPentestLanding() {
  ...
  const includedItems = [
    { text: 'Android & iOS native app testing' },
    { text: 'Static & dynamic code analysis' },
    { text: 'API & backend security testing' },
    { text: 'Local data storage security' },
    { text: 'Network traffic interception' },
    { text: 'Authentication & authorization' },
    { text: 'Reverse engineering assessment' },
    { text: 'Certificate pinning validation' }
  ];

  const scopeItems = [
    { icon: Database, title: 'Storage Security', desc: 'Local data protection' },
    { icon: Lock, title: 'Authentication', desc: 'Login & biometric security' },
    { icon: Wifi, title: 'Network Traffic', desc: 'Data transmission security' },
    { icon: Code, title: 'Reverse Engineering', desc: 'Code obfuscation testing' },
    { icon: FileCode, title: 'Backend APIs', desc: 'Server communication' },
    { icon: Key, title: 'Cryptography', desc: 'Encryption implementation' },
    { icon: Shield, title: 'Permissions', desc: 'Access control testing' },
    { icon: Smartphone, title: 'Platform Security', desc: 'OS-specific vulnerabilities' }
  ];
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="mb-6 md:mb-8">
            ...
            <p className="text-gray-400 text-base sm:text-lg md:text-xl max-w-full sm:max-w-2xl mb-6 sm:mb-8 leading-relaxed">
              Comprehensive security assessment for iOS and Android
              applications, including static analysis, dynamic testing, and
