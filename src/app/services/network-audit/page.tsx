...
export default function NetworkSecurityAuditLanding() {
  ...
  const includedItems = [
    { text: 'Comprehensive network mapping' },
    { text: 'Firewall rule review & testing' },
    { text: 'Port scanning & service enumeration' },
    { text: 'Network device configuration review' },
    { text: 'Wireless security assessment' },
    { text: 'Network segmentation validation' },
    { text: 'VPN & remote access security' },
    { text: 'IDS/IPS effectiveness testing' }
  ];

  const scopeItems = [
    { icon: Network, title: 'Network Topology', desc: 'Architecture mapping' },
    { icon: Shield, title: 'Firewalls', desc: 'Rule analysis & bypass' },
    { icon: Globe, title: 'Routers & Switches', desc: 'Device configurations' },
    { icon: Wifi, title: 'Wireless', desc: 'WiFi security audit' },
    { icon: Lock, title: 'VPN', desc: 'Remote access security' },
    { icon: Target, title: 'IDS/IPS', desc: 'Detection systems' },
    { icon: Globe, title: 'Segmentation', desc: 'Network isolation' },
    { icon: AlertCircle, title: 'Vulnerabilities', desc: 'Network-level flaws' }
  ];
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="mb-6 md:mb-8">
            ...
            <p className="text-gray-400 text-base sm:text-lg md:text-xl max-w-full sm:max-w-2xl mb-6 sm:mb-8 leading-relaxed">
              Comprehensive assessment of network architecture,
              configurations, and security controls to identify vulnerabilities and
